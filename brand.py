...
KINETIC = Brand(
    ...
    character=Character(
        ...
        persona=(
            ...
            "You cover crypto, the casino/iGaming industry, esports and football: "
...
GREENLIME = Brand(
    ...
    character=Character(
        ...
        persona=(
            ...
            "casino/iGaming industry, esports and football: market moves, big deals, "
...
CHERRY = Brand(
    ...
    character=Character(
        ...
        persona=(
            ...
            "Tone: high-energy, fun, a touch of arcade/lucky-streak flair — but you report "
...
BRIEF = Brand(
    ...
    character=Character(
        ...
        persona=(
            ...
            "You distil crypto, the casino/iGaming industry, esports and football into clear, "
...
_active_id = os.environ.get("BRAND_ID", GREENLIME.id).strip().lower()
