...
HOOK_CAPTION = {
    "en": (
        ...
        "• 🍒 breaking drops across crypto, casino, esports & football\n"
        "• 🔴 live scores in real time\n"
        "• ⚡ first alerts before the spin stops\n\n"
    ...
    "ru": (
        ...
        "• 🍒 свежие дропы по крипте, казино, киберспорту и футболу\n"
    ...
    "es": (
        ...
        "• 🍒 novedades de cripto, casino, esports y fútbol\n"
